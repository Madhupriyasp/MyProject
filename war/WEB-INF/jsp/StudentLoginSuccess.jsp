...
<div class="container" style="top:200px;left:140px;position:absolute" >  


   <h5 style="top:50px"> <em>  ${message}</em>     </h5>
  ...
  <div class="table-responsive"style="left:300px;top:-0px;position:absolute;width:600px">          
  <table class="table">
